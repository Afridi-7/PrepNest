      ...
      <div className="relative hidden overflow-hidden lg:flex lg:w-1/2 items-center justify-center p-12 gradient-primary">
        ...
        >
          ...
          <div className="mt-8 grid grid-cols-3 gap-2 text-xs text-white/95">
            <div className="rounded-xl border border-white/25 bg-white/10 p-3 backdrop-blur-sm transition-all hover:bg-white/20"><ShieldCheck className="mx-auto mb-1 h-4 w-4" />Secure</div>
            <div className="rounded-xl border border-white/25 bg-white/10 p-3 backdrop-blur-sm transition-all hover:bg-white/20"><Zap className="mx-auto mb-1 h-4 w-4" />Fast</div>
            <div className="rounded-xl border border-white/25 bg-white/10 p-3 backdrop-blur-sm transition-all hover:bg-white/20"><Sparkles className="mx-auto mb-1 h-4 w-4" />Smart</div>
          </div>
        </motion.div>
      </div>

      <div className="relative z-10 flex flex-1 items-center justify-center p-4 sm:p-6">
        {/* Subtle background orb on mobile */}
