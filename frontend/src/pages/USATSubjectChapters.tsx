            ...
            <div className="grid gap-4 lg:grid-cols-[1.2fr_1fr]">
              ...
              >
                ...
                <div className="mt-5 rounded-xl border border-slate-200 bg-slate-50 p-3">
                  <h3 className="mb-2 inline-flex items-center gap-1 text-sm font-semibold text-slate-800"><FileText className="h-4 w-4" /> {selectedChapter?.title || "Chapter"} Materials</h3>
                  {selectedChapterMaterials.length === 0 ? (
                    ...
                    <div className="space-y-2">
                      {selectedChapterMaterials.map((material) => {
                        ...
                        return (
                          <div key={material.id} className="rounded-lg border border-slate-200 bg-white p-2">
                ...
                <div className="mt-4 rounded-xl border border-slate-200 bg-slate-50 p-3">
                  <h3 className="mb-2 inline-flex items-center gap-1 text-sm font-semibold text-slate-800"><ListChecks className="h-4 w-4" /> {selectedChapter?.title || "Chapter"} MCQs</h3>
                  {selectedChapterMcqs.length === 0 ? (
                    <p className="text-xs text-slate-500">No chapter MCQs yet.</p>
                  ) : (
                    <div className="space-y-2">
                      {selectedChapterMcqs.slice(0, 6).map((mcq, index) => (
                        <div key={mcq.id} className="rounded-lg border border-slate-200 bg-white p-2">
